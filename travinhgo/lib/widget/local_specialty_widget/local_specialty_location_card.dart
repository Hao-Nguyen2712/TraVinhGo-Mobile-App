...
import 'package:travinhgo/widget/local_specialty_widget/local_specialty_detail_dialog.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

class LocalSpecialtyLocationCard extends StatelessWidget {
  final LocalSpecialtyLocation location;
  final String tagImage;

  const LocalSpecialtyLocationCard({
    super.key,
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: LocalSpecialtyDetailDialog(
                            location: location,
                            tagImage: tagImage,
                          ),
                        );
